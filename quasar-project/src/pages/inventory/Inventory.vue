  ...
  setup () {
    ...
    const fetchInventory = async () => {
        ...
        try {
          ...
          inventory.value = response.data.data.data // <- actual inventory list
          pagination.value.rowsNumber = response.data.data.total // <- total number of records
        } catch (error) {
    ...
    onMounted(async () => {
      loading.value = true
      try {
        await branchStore.fetchBranchDetailsforInventory(route.params.businessId, route.params.branchId)
